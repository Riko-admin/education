...
### Использовать команду Fetch
### Результат.
![Меню](https://github.com/Riko-admin/education/blob/Тема_1.2/pic/6.png) 
## Самостоятельная работа №9
### Удалить файл из рабочего каталога
### Результат.
![Меню](https://github.com/Riko-admin/education/blob/Тема_1.2/pic/7.png) 
